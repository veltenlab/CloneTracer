...
option_list <- list(
    ...
    make_option(c("-o", "--outprefix"), type = "character", default = NULL,
        help = "Prefix for the output files. If a different directory is desired it should be specified 
            A csv and a BED file with primer information will be generated",
        metavar = "character"),
...
## Check that the input table has the correct column names
...
## pick outer primers based on the penalty score
