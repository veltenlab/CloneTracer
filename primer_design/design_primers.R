...
option_list = list(
  ...
  make_option(c("-b", "--bam"), type = "character", default = NULL,
              ...
              metavar = "character"),
  make_option(c("-b", "--outdir_gene_exp"), type = "character", default = NULL,
  ...
  make_option(c("-d", "--out_directory"), type = "character", default = NULL,
              help = "directory where bed files will be saved for inspection in genome browser", 
              metavar = "character"),  
  make_option(c("-t", "--multimodal"), type = "boolean", default = FALSE,
              help = "Boolean indicating whether more than one modality was measure from the same cells (e.g. surface proteins or ATAC + RNA). Default: FALSE", 
              metavar = "character"),  
...
required_args <- c("input_csv", "bam", "name", "read_length","out_directory", "outdir_gene_exp",
                   "multimodal","cores","gtf_file", "outfile")
...
opt <- list(input_csv = "data/variants_P6.csv", bam = "../../../gene_expression/data/P19003-11/outs/possorted_genome_bam.bam", 
            gtf_file = "../../../../../sbeneyto/alignment_references/GRCh38/Homo_sapiens.GRCh38.100.chr.gtf",
            name = "P6",
            outdir_gene_exp = "../../../gene_expression/data/P19003-11/outs",
            cores = 8, 
            multimodal = T,
            read_length = 120,
            out_directory = "P6_files",
            outfile = "P6_files/annotates_variants_P6.csv")

setwd("~/cluster/project/AML/git/MutaSeq-v2/primer_design/")
...
export(filtered_transcripts, con = paste0(opt$out_directory, "/all_genes.bed"), format = "bed")
