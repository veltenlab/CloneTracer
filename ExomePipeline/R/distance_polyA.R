        ...
        if(length(mutation_position) > 1){
            ...
            if(strand(tail_candidates)@values == "+"){
                ...
                if(min_pos(distances) == Inf){
                    ...
                    selected_tail <- tail_candidates[which(distances %in% min_pos(distances))]}
            }else{
